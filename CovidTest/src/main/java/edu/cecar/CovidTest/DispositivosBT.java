...
public class DispositivosBT extends AppCompatActivity {
    ...
    private static final String TAG = "DispositivosBT"; //<-<- PARTE A MODIFICAR  OK>->->
    ...
    public void onResume() {
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter(this, R.layout.nombre_dispositivos);//<-<- PARTE A MODIFICAR OK>->->
        // Presenta los disposisitivos vinculados en el ListView
        IdLista = (ListView) findViewById(R.id.listaDispositivos);
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            Intent i = new Intent(DispositivosBT.this, InicioCovidTest.class);//<-<- PARTE A MODIFICAR OK >->->
